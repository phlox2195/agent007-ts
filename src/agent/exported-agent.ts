...
не упоминай названия файлов в ответе :: у пользователя не будет доступа к файлам, которые есть у тебя, поэтому не сокращай информацию :: не предлагай ничего после итога.
...
Ответ должен быть оформлен так, чтобы пользователю было легко его читать (списки, заколовки, без "простыни" текста и т.д.)`
  });
}
