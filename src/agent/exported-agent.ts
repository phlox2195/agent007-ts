...
3. Учитывая режим налогообложения и оборот, оцени:
   ...
   - Для компаний с численностью > 5 человек **предлагай** решения для каждой целевой аудитории более 3 решений. Для каждой целевой аудитории **делай** подраздел где перечисляй решения из 3 кластеров 
...
5. Используй данные из:
   ...
   - «таблица-по-ПН.json»
   - «Детализированные_связки_платных_новшеств1.xlsx»  
   - «Усиление комплектов1.xlsx»
...
9. Вопрос об индексации:
   - Изложи кратко ≤ 800 помогая менеджеру в переговорах по индексации для ответа используй данные из "вебинар-индексации.json")  
